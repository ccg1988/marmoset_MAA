...
fitPoints=nan(N, 7);
fitParas=nan(N,4);
cond=2; % azi_Gau_front/RSS_front/Gau_rear***ele_Gau_2to32/4to26/4to12kHz
result_save=cell(N,1);
options.confP=0.68;% other five conditions are 0.68 automatically 
% confidence affect both PF fitting and posterior distribution
for n = 1 : N
