...
hlabel = xlabel(plotOptions.xLabel,'FontSize',plotOptions.labelSize,'FontName', 'Arial');
set(hlabel,'Visible','on')
if plotOptions.tufteAxis
    set(hlabel,'Position',get(hlabel,'Position') - [0 .05 0]);
end
hlabel = ylabel(plotOptions.yLabel,'FontSize',plotOptions.labelSize,'FontName', 'Arial');
set(hlabel,'Visible','on')
if plotOptions.tufteAxis
