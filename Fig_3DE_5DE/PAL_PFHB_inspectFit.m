...
for loop = 1:number
    ...
    for ix = 1:length(x)
        if ~isinf(x(ix))
            ...
            plot(x(ix),y(ix)./n(ix),'o','markersize',5,'color',[0.8 0 0.2],'linewidth',2,'markerfacecolor',[0.8 0 0.2]);
        end
    end
    ...
    if any(infiniteLim)
        ...
        if infiniteLim(1)
            ...
            plot(x(1),y(1)./n(1),'o','markersize',1,'color',[0.8 0 0.2],'linewidth',2,'markerfacecolor',[0.8 0 0.2])
        end
        if infiniteLim(2)
            ...
            plot(x(end),y(end)./n(end),'o','markersize',1,'color',[0.8 0 0.2],'linewidth',2,'markerfacecolor',[0.8 0 0.2])
        end
